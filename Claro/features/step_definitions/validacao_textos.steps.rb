...
2.2 O presente serviço não está disponível para: (I) Clientes pessoa jurídica, cuja contratação seja por um CNPJ; (II) Clientes Pré Pagos que não disponham de saldo suficiente para concluir a contratação; (III) Clientes Pós Pago e Controle que estejam inadimplentes com a Operadora.

3. FORMAS DE CONTRATAÇÃO E CANCELAMENTO DO SERVIÇO
...
4. VALOR, CARACTERÍSTICAS E RESTRIÇÕES DO SERVIÇO

4.1 O serviço VIDA PRÁTICA COM ANA MARIA BRAGA possui o valor de R$ 3,99 (três reais e noventa e nove centavos) por semana, cobrados na fatura do USUÁRIO nos casos de Planos Pós-Pago ou Controle ou mediante desconto do valor devido no momento da recarga seguinte à contratação do conteúdo, de acordo com os termos previstos nos contratos de Prestação do Serviço Móvel Pessoal na modalidade Pré-Pago e de Prestação de Serviço de Acesso à internet na modalidade Pré-Pago, no caso de Pré-Pago.

4.1.1 Ao contratar o serviço pela primeira vez, o usuário poderá usufruir do serviço gratuitamente, conforme descrito no item 3.4.1.

4.1.2 A partir do 4º dia de assinatura, o valor do serviço será cobrado de forma recorrente, a cada semana, até que seja cancelado efetivamente.

4.1.3 O valor do serviço é promocional e poderá retornar a seu valor original e/ou ainda ser reajustado anualmente, a critério exclusivo da CLARO TV.

4.2 A adesão, o cancelamento ou os protocolos registrados no atendimento CLARO serão confirmados ao USUÁRIO por meio de SMSs enviados ao número móvel correspondente.

4.3 A CLARO TV poderá, a qualquer momento, independentemente de prévio aviso, suspender a comercialização do presente serviço, sendo certo que o USUÁRIO não será mais cobrado por ele a partir de seu encerramento.

4.4 Se por qualquer motivo não houver o débito do valor do conteúdo contratado na recarga correspondente, a Claro está autorizada a debitar o valor ou remanescente em qualquer recarga futura realizada.')
end